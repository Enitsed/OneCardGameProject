...
public class UIWaitRoom extends JFrame implements ActionListener, MouseListener {
	 ...
	 * Runnable() { public void run() { try { UIWaitRoom frame = new UIWaitRoom();
	...
	public UIWaitRoom(ClientThread clientThread) {
		...
		panel.setBorder(new TitledBorder(null, "\uD604\uC7AC \uC811\uC18D\uB41C \uC0AC\uC6A9\uC790",
		...
		panel_1.setBorder(new TitledBorder(null, "\uB300\uD654\uBC29 \uBAA9\uB85D", TitledBorder.LEADING,
